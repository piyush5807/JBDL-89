...
public class CreateBookRequest {
    ...
    // removing this field from the client input as it makes the system vulnerable in the sense,
    // any one can forge this parameter to change the admin who is adding the book to the library
//    @NotNull
