...
public class TransactionService {
    ...
    public String initiateTransaction(InitiateTransactionRequest initiateTransactionRequest) throws BadRequestException {
    ...
    private String issueTxn(Transaction transaction) throws BadRequestException {
        /**
